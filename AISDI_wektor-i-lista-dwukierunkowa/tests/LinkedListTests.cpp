...
/*
BOOST_AUTO_TEST_CASE(vector_list)
{
...
{
  //OperationCountingObject::constructedObjectsCount();
...
{
  //OperationCountingObject::destroyedObjectsCount();
...
{
  //OperationCountingObject::copiedObjectsCount();
